...
<div class="flex flex-col gap-4">
  ...
  <div>
    <img src="./assets/chat-ai-ca-nhan-hoa/3.png" alt="Grok3 Mobile View" class="w-full aspect-video" />
    <p class="text-center text-sm text-gray-500">Giao diện responsive trên thiết bị di động</p>
  </div>
  <div>
    <img src="./assets/chat-ai-ca-nhan-hoa/4.png" alt="Grok3 Mobile View" class="w-full aspect-video" />
    <p class="text-center text-sm text-gray-500">Giao diện responsive trên thiết bị di động</p>
  </div>
</div>