...
image: "./assets/chat-ai-ca-nhan-hoa/1.png"
---
...
<img
  src="./assets/chat-ai-ca-nhan-hoa/2.png"
  alt="Grok3 Demo"
...
<div class="flex flex-col gap-4">
  <div>
    <img src="./assets/chat-ai-ca-nhan-hoa/1.png" alt="Grok3 Dark Mode" class="w-full aspect-video" />
    <p class="text-center text-sm text-gray-500">Chế độ tối với giao diện tối ưu cho mắt</p>
  </div>
  <div>
    <img src="./assets/chat-ai-ca-nhan-hoa/2.png" alt="Grok3 Code Highlighting" class="w-full aspect-video" />
    <p class="text-center text-sm text-gray-500">Hiển thị code với syntax highlighting</p>
  </div>
  <div>
    <img src="./assets/chat-ai-ca-nhan-hoa/3.jpg" alt="Grok3 Mobile View" class="w-full aspect-video" />
    <p class="text-center text-sm text-gray-500">Giao diện responsive trên thiết bị di động</p>
  </div>
  <div>
    <img src="./assets/chat-ai-ca-nhan-hoa/4.jpg" alt="Grok3 Mobile View" class="w-full aspect-video" />
    <p class="text-center text-sm text-gray-500">Giao diện responsive trên thiết bị di động</p>
  </div>
</div>