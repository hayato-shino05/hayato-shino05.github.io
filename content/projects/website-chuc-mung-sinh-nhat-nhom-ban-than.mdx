...
1. Tải về mã nguồn bằng cách chạy lệnh:  
...
### Thêm Sinh Nhật Mới
Chỉnh sửa mảng birthdays trong file script.js theo định dạng sau:  
{name: "Tên", month: "1-12", day: "1-31", message: "Lời chúc sinh nhật của bạn"}
...
<div className="flex flex-col gap-4">
  <img src="./assets/website-chuc-mung-sinh-nhat-nhom-ban-than/1.png" alt="Màn hình chính của ứng dụng" width="600" height="400" />
  <img src="./assets/website-chuc-mung-sinh-nhat-nhom-ban-than/2.png" alt="Giao diện chính của ứng dụng" width="600" height="400" />
  <img src="./assets/website-chuc-mung-sinh-nhat-nhom-ban-than/3.png" alt="Màn hình danh sách video thánh lễ" width="600" height="400" />
  <img src="./assets/website-chuc-mung-sinh-nhat-nhom-ban-than/4.png" alt="Màn hình phát video thánh lễ" width="600" height="400" />
  <img src="./assets/website-chuc-mung-sinh-nhat-nhom-ban-than/5.png" alt="Giao diện chi tiết video" width="600" height="400" />
</div>
